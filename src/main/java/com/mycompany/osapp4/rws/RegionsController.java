...
public class RegionsController 
{
	...
	@RequestMapping(value = "/regions/{page}/{size}", method = RequestMethod.GET)
	public ResponseEntity<Page<Regions>> findAll(@PathVariable Integer page, @PathVariable Integer size)
	{		
		return new ResponseEntity<Page<Regions>>(service.findAll(page - 1, size), HttpStatus.OK);
	}
	...
	{    
		...
		return new ResponseEntity<Regions>(service.update(regionsDTO), HttpStatus.OK);
	}
